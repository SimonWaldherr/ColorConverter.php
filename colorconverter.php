...
function colorconv ($input, $mode='parse') {
  ...
  case 'hsv2rgb':
    ...
    break;
  case 'hsl2hex':
    return colorconv(colorconv($input, 'hsl2rgb'), 'rgb2hex');
    break;
  case 'hex2hsl':
    return colorconv(colorconv($input, 'hex2rgb'), 'rgb2hsl');
    break;
  case 'complexity2int':
  ...
  case 'int2rgb':
    ...
    break;
  case 'complexity2rgb':
    return colorconv(colorconv($input, 'complexity2int'), 'int2rgb');
    break;
  case 'mixrgb':
